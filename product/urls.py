...
urlpatterns = [
    ...
    path('inventory/detail/<str:part_id>/', product.product_detail_view,  name='product_detail'),
    path('inventory/detail/', product.get_by_part_warehouse,  name='product_detail'),
